...
void ft5426_init(void)
{
    ...
    /* init int io */
    ctinpin_config.direction = kGPIO_DigitalInput; 
    ...
    /* init reset io */
    ctinpin_config.direction = kGPIO_DigitalOutput;
...
{
    if(ft5426_dev.initflaag = FT5426_INIT_FINISHED)
    {
        ft5426_tpcoord();
    }
